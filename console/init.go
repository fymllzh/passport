...
func main() {
	...
	db.Create(&client.Client{Domain: "client.one.com:8081", Callback: "http://client.one.com:8081/callback", Secret: "123456", Model: base.Model{Status: base.StatusNormal}})
	db.Create(&client.Client{Domain: "client.two.com:8082", Callback: "http://client.two.com:8082/callback", Secret: "123456", Model: base.Model{Status: base.StatusNormal}})
	...
	db.Create(&user.User{Email: u, Password: p, Model: base.Model{Status: base.StatusNormal}})
